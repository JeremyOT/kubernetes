...
var serviceexportsResource = schema.GroupVersionResource{Group: "multicluster.k8s.io", Version: "v1alpha1", Resource: "serviceexports"}

var serviceexportsKind = schema.GroupVersionKind{Group: "multicluster.k8s.io", Version: "v1alpha1", Kind: "ServiceExport"}
