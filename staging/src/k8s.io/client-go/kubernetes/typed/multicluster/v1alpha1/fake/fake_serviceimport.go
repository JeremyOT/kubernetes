...
var serviceimportsResource = schema.GroupVersionResource{Group: "multicluster.k8s.io", Version: "v1alpha1", Resource: "serviceimports"}

var serviceimportsKind = schema.GroupVersionKind{Group: "multicluster.k8s.io", Version: "v1alpha1", Kind: "ServiceImport"}
