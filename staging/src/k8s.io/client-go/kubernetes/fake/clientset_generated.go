...
import (
	...
	multiclusterv1alpha1 "k8s.io/client-go/kubernetes/typed/multicluster/v1alpha1"
	fakemulticlusterv1alpha1 "k8s.io/client-go/kubernetes/typed/multicluster/v1alpha1/fake"
